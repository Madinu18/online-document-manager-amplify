    ...
    <Container>
      <SpaceBetween size="l">
        <ProgressBar
          ...
          label={
            filename === undefined
              ? "Click in the button to upload a file"
        ...
        <div>
          ...
          <Button>
            <label htmlFor="icon-button-file">Upload new file</label>
          </Button>
          ...
          <ExpandableSection headerText="Identify text (available only for documents)">
            <Form>
              ...
              >
                ...
                <Header variant="h5">Key Values found</Header>
                <TokenGroup items={keyValueTokenGroup} />

                <Header variant="h5">First lines found</Header>
                ...
                {interpret == null || interpret === undefined ? (
                  ...
                  <>
                    <Header variant="h5">Sentiment</Header>
                    <PieChart
                      data={[
                        {
                          title: "Mixed",
